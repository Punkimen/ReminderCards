// Package model for postgresql model
package model
...
// CreateCard saves a card and returns it with the ID and creation time
...
// GetAllCards returns all cards, with the newest cards first.
